...
Embucket uses [Apache Iceberg](https://iceberg.apache.org/)—an open table format—to store your data and a lightweight in-memory metastore to manage metadata.
