...
Embucket uses the [dbt](https://docs.getdbt.com/) Gitlab project as a compatibility benchmark. The Embucket [repository](https://github.com/Embucket/embucket) displays current compatibility badges for both SLT test suite and dbt Gitlab.
...
<Aside type="note">This feature is under development.</Aside>
