...
Make sure you follow dbt's [official documentation](https://docs.getdbt.com/docs/introduction) to set up dbt project. Assuming you have a dbt project set up, you can add `snowplow_web` package to your `packages.yml`:
