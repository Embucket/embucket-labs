...
create or replace transient table EMBUCKET.zuora_revenue.zuora_revenue_revenue_contract_schedule_deleted_source
    

    
    as (WITH zuora_revenue_revenue_contract_schedule_deleted AS (
