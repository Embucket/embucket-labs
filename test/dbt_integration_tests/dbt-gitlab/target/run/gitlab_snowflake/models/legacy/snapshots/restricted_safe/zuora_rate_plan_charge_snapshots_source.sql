...
create or replace transient table EMBUCKET.restricted_safe_legacy.zuora_rate_plan_charge_snapshots_source
    

    
    as (-- depends_on: EMBUCKET.seed_finance.zuora_excluded_accounts
