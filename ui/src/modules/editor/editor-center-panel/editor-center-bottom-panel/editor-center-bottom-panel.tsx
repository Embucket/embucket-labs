...
import { EditorCenterBottomPanelSelectedCell } from './editor-center-bottom-panel-selected-cell.tsx';
            ...
            <ResizablePanelGroup direction="horizontal" className="size-full">
              <ResizablePanel order={1} defaultSize={selectedCellId ? 70 : 100} minSize={50}>
                <ScrollArea tableViewport className="size-full" ref={scrollRootRef}>
                  <EditorCenterBottomPanelQueryResultTable
              ...
              {selectedCellId && <EditorResizableHandle />}
              ...
              {selectedCellId && (
                ...
                >
                  <EditorCenterBottomPanelSelectedCell
                    selectedCellId={selectedCellId}
                    columns={columns}
                    rows={rows}
