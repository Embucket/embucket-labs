...
export type GetQueriesQueryError = ErrorType<ErrorResponse | ErrorResponse | ErrorResponse>;
...
export type CreateQueryMutationError = ErrorType<
...
export type GetQueryQueryError = ErrorType<ErrorResponse | ErrorResponse | ErrorResponse>;
