...
pub const AGGREGATE_FUNCTIONS: &[(&str, FunctionInfo)] = &[
    ("ANY_VALUE", FunctionInfo::new(
        "ANY_VALUE",
        "Returns some value of the expression from the group."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/any_value")
    ),
    ...
    ("ARRAY_AGG", FunctionInfo::new(
        "ARRAY_AGG",
        "Returns the input values, pivoted into an array."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/array_agg")
    ),
    ("ARRAY_UNION_AGG", FunctionInfo::new(
        "ARRAY_UNION_AGG",
        "Returns an ARRAY that contains the union of the distinct values from the input ARRAYs in a column."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/array_union_agg")
    ),
    ("ARRAY_UNIQUE_AGG", FunctionInfo::new(
        "ARRAY_UNIQUE_AGG",
        "Returns an ARRAY that contains all of the distinct values from the specified column."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/array_unique_agg")
    ),
    ("AVG", FunctionInfo::new(
        "AVG",
        "Returns the average of non-NULL records."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/avg")
    ),
    ...
    ("BOOLAND_AGG", FunctionInfo::new(
        "BOOLAND_AGG",
        "Returns TRUE if all non-NULL Boolean records in a group evaluate to TRUE."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/booland_agg")
    ),
    ("BOOLOR_AGG", FunctionInfo::new(
        "BOOLOR_AGG",
        "Returns TRUE if at least one Boolean record in a group evaluates to TRUE."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/boolor_agg")
    ),
    ("BOOLXOR_AGG", FunctionInfo::new(
        "BOOLXOR_AGG",
        "Returns TRUE if exactly one Boolean record in the group evaluates to TRUE."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/boolxor_agg")
    ),
    ("CORR", FunctionInfo::new(
        "CORR",
        "Returns the correlation coefficient for non-null pairs in a group."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/corr")
    ),
    ("COUNT", FunctionInfo::new(
        "COUNT",
        "Returns either the number of non-NULL records for the specified columns, or the total number of records."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/count")
    ),
    ...
    ("COVAR_POP", FunctionInfo::new(
        "COVAR_POP",
        "Returns the population covariance for non-null pairs in a group."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/covar_pop")
    ),
    ("COVAR_SAMP", FunctionInfo::new(
        "COVAR_SAMP",
        "Returns the sample covariance for non-null pairs in a group."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/covar_samp")
    ),
    ("GROUPING", FunctionInfo::new(
        "GROUPING",
        "Describes which of a list of expressions are grouped in a row produced by a GROUP BY query."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/grouping")
    ),
    ...
    ("MAX", FunctionInfo::new(
        "MAX",
        "Returns the maximum value for the records within expr."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/max")
    ),
    ...
    ("MEDIAN", FunctionInfo::new(
        "MEDIAN",
        "Determines the median of a set of values."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/median")
    ),
    ("MIN", FunctionInfo::new(
        "MIN",
        "Returns the minimum value for the records within expr."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/min")
    ),
    ...
    ("OBJECT_AGG", FunctionInfo::new(
        "OBJECT_AGG",
        "Returns one OBJECT per group."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/object_agg")
    ),
    ("PERCENTILE_CONT", FunctionInfo::new(
        "PERCENTILE_CONT",
        "Return a percentile value based on a continuous distribution of the input column (specified in order_by_expr)."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/percentile_cont")
    ),
    ...
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/regr_avgx")
    ),
    ("REGR_AVGY", FunctionInfo::new(
        "REGR_AVGY",
    ...
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/regr_avgy")
    ),
    ("REGR_COUNT", FunctionInfo::new(
        "REGR_COUNT",
        "Returns the number of non-null number pairs in a group."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/regr_count")
    ),
    ("REGR_INTERCEPT", FunctionInfo::new(
        "REGR_INTERCEPT",
        "Returns the intercept of the univariate linear regression line for non-null pairs in a group."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/regr_intercept")
    ),
    ("REGR_R2", FunctionInfo::new(
        "REGR_R2",
        "Returns the coefficient of determination for non-null pairs in a group."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/regr_r2")
    ),
    ("REGR_SLOPE", FunctionInfo::new(
        "REGR_SLOPE",
        "Returns the slope of the linear regression line for non-null pairs in a group."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/regr_slope")
    ),
    ("REGR_SXX", FunctionInfo::new(
        "REGR_SXX",
        "Returns REGR_COUNT(y, x) * VAR_POP(x) for non-null pairs."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/regr_sxx")
    ),
    ("REGR_SXY", FunctionInfo::new(
        "REGR_SXY",
        "Returns REGR_COUNT(expr1, expr2) * COVAR_POP(expr1, expr2) for non-null pairs."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/regr_sxy")
    ),
    ("REGR_SYY", FunctionInfo::new(
        "REGR_SYY",
        "Returns REGR_COUNT(y, x) * VAR_POP(y) for non-null pairs."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/regr_syy")
    ),
    ...
    ("STDDEV, STDDEV_SAMP", FunctionInfo::new(
        "STDDEV, STDDEV_SAMP",
        "Returns the sample standard deviation (square root of sample variance) of non-NULL values."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/stddev")
    ),
    ("STDDEV_POP", FunctionInfo::new(
        "STDDEV_POP",
        "Returns the population standard deviation (square root of variance) of non-NULL values."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/stddev_pop")
    ),
    ("SUM", FunctionInfo::new(
        "SUM",
        "Returns the sum of non-NULL records for expr."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/sum")
    ),
    ("VARIANCE , VARIANCE_SAMP", FunctionInfo::new(
    ...
    ("VAR_POP", FunctionInfo::new(
        "VAR_POP",
        "Returns the population variance of non-NULL records in a group."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/var_pop")
    ),
    ("VAR_SAMP", FunctionInfo::new(
        "VAR_SAMP",
        "Returns the sample variance of non-NULL records in a group."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/var_samp")
    ),
];
...
pub const CONDITIONAL_FUNCTIONS: &[(&str, FunctionInfo)] = &[
    ("BOOLAND", FunctionInfo::new(
        "BOOLAND",
        "Computes the Boolean AND of two numeric expressions."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/booland")
    ),
    ...
    ("BOOLOR", FunctionInfo::new(
        "BOOLOR",
        "Computes the Boolean OR of two numeric expressions."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/boolor")
    ),
    ("BOOLXOR", FunctionInfo::new(
        "BOOLXOR",
        "Computes the Boolean XOR of two numeric expressions (i.e. one of the expressions, but not both expressions, is TRUE)."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/boolxor")
    ),
    ...
    ("COALESCE", FunctionInfo::new(
        "COALESCE",
        "Returns the first non-NULL expression among its arguments, or NULL if all its arguments are NULL."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/coalesce")
    ),
    ("DECODE", FunctionInfo::new(
        "DECODE",
        "Compares the select expression to each search expression in order."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/decode")
    ),
    ("EQUAL_NULL", FunctionInfo::new(
        "EQUAL_NULL",
        "Compares whether two expressions are equal."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/equal_null")
    ),
    ("GREATEST", FunctionInfo::new(
        "GREATEST",
        "Returns the largest value from a list of expressions."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/greatest")
    ),
    ...
    ("IFF", FunctionInfo::new(
        "IFF",
        "Returns one of two values depending on whether a Boolean expression evaluates to true or false."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/iff")
    ),
    ("IFNULL", FunctionInfo::new(
        "IFNULL",
        "If expr1 is NULL, returns expr2, otherwise returns expr1."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/ifnull")
    ),
    ("IS [ NOT ] DISTINCT FROM", FunctionInfo::new(
        "IS [ NOT ] DISTINCT FROM",
        "Compares whether two expressions are equal (or not equal)."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/is-distinct-from")
    ),
    ("IS [ NOT ] NULL", FunctionInfo::new(
        "IS [ NOT ] NULL",
        "Determines whether an expression is NULL or is not NULL."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/is-null")
    ),
    ("LEAST", FunctionInfo::new(
        "LEAST",
        "Returns the smallest value from a list of expressions."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/least")
    ),
    ...
    ("NULLIF", FunctionInfo::new(
        "NULLIF",
        "Returns NULL if expr1 is equal to expr2, otherwise returns expr1."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/nullif")
    ),
    ("NULLIFZERO", FunctionInfo::new(
        "NULLIFZERO",
        "Returns NULL if the argument evaluates to 0; otherwise, returns the argument."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/nullifzero")
    ),
    ("NVL", FunctionInfo::new(
        "NVL",
        "If expr1 is NULL, returns expr2, otherwise returns expr1."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/nvl")
    ),
    ("NVL2", FunctionInfo::new(
        "NVL2",
        "Returns values depending on whether the first input is NULL."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/nvl2")
    ),
...
pub const CONTEXT_FUNCTIONS: &[(&str, FunctionInfo)] = &[
    ...
    ("CURRENT_CLIENT", FunctionInfo::new(
        "CURRENT_CLIENT",
        "Returns the version of the client from which the function was called."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/current_client")
    ),
    ("CURRENT_DATABASE", FunctionInfo::new(
        "CURRENT_DATABASE",
        "Returns the name of the current database, which varies depending on where you call the function."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/current_database")
    ),
    ("CURRENT_DATE", FunctionInfo::new(
        "CURRENT_DATE",
        "Returns the current date of the system."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/current_date")
    ),
    ...
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/current_role")
    ),
    ("CURRENT_ROLE_TYPE", FunctionInfo::new(
        "CURRENT_ROLE_TYPE",
    ...
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/current_role_type")
    ),
    ("CURRENT_SCHEMA", FunctionInfo::new(
        "CURRENT_SCHEMA",
        "Returns the name of the current schema, which varies depending on where you call the function."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/current_schema")
    ),
    ("CURRENT_SCHEMAS", FunctionInfo::new(
        "CURRENT_SCHEMAS",
        "Returns active search path schemas."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/current_schemas")
    ),
    ...
    ("CURRENT_SESSION", FunctionInfo::new(
        "CURRENT_SESSION",
        "Returns a unique system identifier for the Snowflake session corresponding to the present connection."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/current_session")
    ),
    ...
    ("CURRENT_TIME", FunctionInfo::new(
        "CURRENT_TIME",
        "Returns the current time for the system."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/current_time")
    ),
    ("CURRENT_TIMESTAMP", FunctionInfo::new(
        "CURRENT_TIMESTAMP",
        "Returns the current timestamp for the system in the local time zone."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/current_timestamp")
    ),
    ...
    ("CURRENT_VERSION", FunctionInfo::new(
        "CURRENT_VERSION",
        "Returns the current Snowflake version."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/current_version")
    ),
    ("CURRENT_WAREHOUSE", FunctionInfo::new(
        "CURRENT_WAREHOUSE",
        "Returns the name of the warehouse in use for the current session."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/current_warehouse")
    ),
...
pub const CONVERSION_FUNCTIONS: &[(&str, FunctionInfo)] = &[
    ...
    ("TO_DECIMAL , TO_NUMBER , TO_NUMERIC", FunctionInfo::new(
    ...
    ("TO_TIME , TIME", FunctionInfo::new(
        "TO_TIME , TIME",
        "Converts an input expression into a time."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/to_time")
    .with_subcategory("datetime")
    ),
    ("TO_TIMESTAMP / TO_TIMESTAMP_*", FunctionInfo::new(
    ...
    ("TRY_TO_BOOLEAN", FunctionInfo::new(
        "TRY_TO_BOOLEAN",
    ...
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/try_to_boolean")
    ),
    ...
    ("TRY_TO_DECIMAL, TRY_TO_NUMBER, TRY_TO_NUMERIC", FunctionInfo::new(
    ...
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/try_to_time")
    ),
    ("TRY_TO_TIMESTAMP / TRY_TO_TIMESTAMP_*", FunctionInfo::new(
...
pub const DATA_METRIC_FUNCTIONS: &[(&str, FunctionInfo)] = &[
    ("AVG (system data metric function)", FunctionInfo::new(
        "AVG (system data metric function)",
        "Returns the average value for the specified column in a table."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/dmf_avg")
    ),
    ("BLANK_COUNT (system data metric function)", FunctionInfo::new(
    ...
    ("BLANK_PERCENT (system data metric function)", FunctionInfo::new(
    ...
    ("DATA_METRIC_SCHEDULED_TIME (system data metric function)", FunctionInfo::new(
    ...
    ("DUPLICATE_COUNT (system data metric function)", FunctionInfo::new(
    ...
    ("FRESHNESS (system data metric function)", FunctionInfo::new(
    ...
    ("MAX (system data metric function)", FunctionInfo::new(
        "MAX (system data metric function)",
        "Returns the maximum value for the specified column in a table."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/dmf_max")
    ),
    ("MIN (system data metric function)", FunctionInfo::new(
        "MIN (system data metric function)",
        "Returns the minimum value for the specified column in a table."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/dmf_min")
    ),
    ("NULL_COUNT (system data metric function)", FunctionInfo::new(
    ...
    ("NULL_PERCENT (system data metric function)", FunctionInfo::new(
    ...
    ("ROW_COUNT (system data metric function)", FunctionInfo::new(
    ...
    ("STDDEV (system data metric function)", FunctionInfo::new(
        "STDDEV (system data metric function)",
        "Returns the standard deviation value for the specified column in a table."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/dmf_stddev")
    ),
    ("UNIQUE_COUNT (system data metric function)", FunctionInfo::new(
...
pub const DATETIME_FUNCTIONS: &[(&str, FunctionInfo)] = &[
    ...
    ("CONVERT_TIMEZONE", FunctionInfo::new(
        "CONVERT_TIMEZONE",
        "Converts a timestamp to another time zone."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/convert_timezone")
    ),
    ("DATEADD", FunctionInfo::new(
        "DATEADD",
        "Adds the specified value for the specified date or time part to a date, time, or timestamp."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/dateadd")
    ),
    ("DATEDIFF", FunctionInfo::new(
        "DATEDIFF",
        "Calculates the difference between two date, time, or timestamp expressions based on the date or time part requested."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/datediff")
    ),
    ("DATE_FROM_PARTS", FunctionInfo::new(
        "DATE_FROM_PARTS",
        "Creates a date from individual numeric components that represent the year, month, and day of the month."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/date_from_parts")
    ),
    ("DATE_PART", FunctionInfo::new(
        "DATE_PART",
        "Extracts the specified date or time part from a date, time, or timestamp."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/date_part")
    ),
    ("DATE_TRUNC", FunctionInfo::new(
        "DATE_TRUNC",
        "Truncates a DATE, TIME, or TIMESTAMP value to the specified precision."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/date_trunc")
    ),
    ...
    ("HOUR / MINUTE / SECOND", FunctionInfo::new(
        "HOUR / MINUTE / SECOND",
    ...
    ("TIMEADD", FunctionInfo::new(
        "TIMEADD",
        "Adds the specified value for the specified date or time part to a date, time, or timestamp."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/timeadd")
    ),
    ("TIMEDIFF", FunctionInfo::new(
        "TIMEDIFF",
        "Calculates the difference between two date, time, or timestamp expressions based on the specified date or time part."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/timediff")
    ),
    ("TIMESTAMPADD", FunctionInfo::new(
        "TIMESTAMPADD",
        "Adds the specified value for the specified date or time part to a date, time, or timestamp."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/timestampadd")
    ),
    ("TIMESTAMPDIFF", FunctionInfo::new(
        "TIMESTAMPDIFF",
        "Calculates the difference between two date, time, or timestamp expressions based on the specified date or time part."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/timestampdiff")
    ),
    ("TIMESTAMP_FROM_PARTS", FunctionInfo::new(
        "TIMESTAMP_FROM_PARTS",
        "Creates a timestamp from individual numeric components."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/timestamp_from_parts")
    ),
    ("TIME_FROM_PARTS", FunctionInfo::new(
        "TIME_FROM_PARTS",
        "Creates a time from individual numeric components."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/time_from_parts")
    ),
    ...
    ("TRUNC", FunctionInfo::new(
        "TRUNC",
        "Truncates a DATE, TIME, or TIMESTAMP value to the specified precision."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/trunc2")
    ),
    ("YEAR* / DAY* / WEEK* / MONTH / QUARTER", FunctionInfo::new(
...
pub const GENERATION_FUNCTIONS: &[(&str, FunctionInfo)] = &[
    ...
    ("RANDOM", FunctionInfo::new(
        "RANDOM",
        "Each call returns a pseudo-random 64-bit integer."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/random")
    ),
    ...
    ("SEQ1 / SEQ2 / SEQ4 / SEQ8", FunctionInfo::new(
        "SEQ1 / SEQ2 / SEQ4 / SEQ8",
...
pub const GEOSPATIAL_FUNCTIONS: &[(&str, FunctionInfo)] = &[
    ...
    ("ST_ASWKB , ST_ASBINARY", FunctionInfo::new(
    ...
    ("ST_ASWKT , ST_ASTEXT", FunctionInfo::new(
        "ST_ASWKT , ST_ASTEXT",
    ...
    ("ST_MAKEGEOMPOINT , ST_GEOMPOINT", FunctionInfo::new(
    ...
    ("ST_MAKEPOINT , ST_POINT", FunctionInfo::new(
    ...
    ("ST_MAKEPOLYGON , ST_POLYGON", FunctionInfo::new(
    ...
    ("ST_NPOINTS , ST_NUMPOINTS", FunctionInfo::new(
...
pub const INFORMATION_SCHEMA_FUNCTIONS: &[(&str, FunctionInfo)] = &[
    ...
    ("DATABASE_REFRESH_PROGRESS , DATABASE_REFRESH_PROGRESS_BY_JOB", FunctionInfo::new(
    ...
    ("LOGIN_HISTORY , LOGIN_HISTORY_BY_USER", FunctionInfo::new(
    ...
    ("QUERY_HISTORY , QUERY_HISTORY_BY_*", FunctionInfo::new(
    ...
    ("REPLICATION_GROUP_REFRESH_PROGRESS, REPLICATION_GROUP_REFRESH_PROGRESS_BY_JOB", FunctionInfo::new(
...
pub const NUMERIC_FUNCTIONS: &[(&str, FunctionInfo)] = &[
    ("ABS", FunctionInfo::new(
        "ABS",
        "Returns the absolute value of a numeric expression."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/abs")
    ),
    ("ACOS", FunctionInfo::new(
        "ACOS",
        "Computes the inverse cosine (arc cosine) of its input; the result is a number in the interval [0, pi]."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/acos")
    ),
    ("ACOSH", FunctionInfo::new(
        "ACOSH",
        "Computes the inverse (arc) hyperbolic cosine of its input."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/acosh")
    ),
    ("ASIN", FunctionInfo::new(
        "ASIN",
        "Computes the inverse sine (arc sine) of its argument; the result is a number in the interval [-pi/2, pi/2]."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/asin")
    ),
    ("ASINH", FunctionInfo::new(
        "ASINH",
        "Computes the inverse (arc) hyperbolic sine of its argument."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/asinh")
    ),
    ("ATAN", FunctionInfo::new(
        "ATAN",
        "Computes the inverse tangent (arc tangent) of its argument; the result is a number in the interval [-pi, pi]."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/atan")
    ),
    ("ATAN2", FunctionInfo::new(
        "ATAN2",
        "Computes the inverse tangent (arc tangent) of the ratio of its two arguments."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/atan2")
    ),
    ("ATANH", FunctionInfo::new(
        "ATANH",
        "Computes the inverse (arc) hyperbolic tangent of its argument."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/atanh")
    ),
    ("CBRT", FunctionInfo::new(
        "CBRT",
        "Returns the cubic root of a numeric expression."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/cbrt")
    ),
    ("CEIL", FunctionInfo::new(
        "CEIL",
    ...
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/ceil")
    ),
    ("COS", FunctionInfo::new(
        "COS",
        "Computes the cosine of its argument; the argument should be expressed in radians."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/cos")
    ),
    ("COSH", FunctionInfo::new(
        "COSH",
        "Computes the hyperbolic cosine of its argument."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/cosh")
    ),
    ("COT", FunctionInfo::new(
        "COT",
        "Computes the cotangent of its argument; the argument should be expressed in radians."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/cot")
    ),
    ("DEGREES", FunctionInfo::new(
        "DEGREES",
        "Converts radians to degrees."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/degrees")
    ),
    ...
    ("EXP", FunctionInfo::new(
        "EXP",
        "Computes Euler’s number e raised to a floating-point value."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/exp")
    ),
    ("FACTORIAL", FunctionInfo::new(
        "FACTORIAL",
        "Computes the factorial of its input."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/factorial")
    ),
    ("FLOOR", FunctionInfo::new(
        "FLOOR",
    ...
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/floor")
    ),
    ("LN", FunctionInfo::new(
        "LN",
        "Returns the natural logarithm of a numeric expression."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/ln")
    ),
    ("LOG", FunctionInfo::new(
        "LOG",
        "Returns the logarithm of a numeric expression."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/log")
    ),
    ...
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/pi")
    ),
    ("POW, POWER", FunctionInfo::new(
        "POW, POWER",
        "Returns a number (x) raised to the specified power (y)."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/pow")
    ),
    ("RADIANS", FunctionInfo::new(
        "RADIANS",
        "Converts degrees to radians."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/radians")
    ),
    ("ROUND", FunctionInfo::new(
        "ROUND",
        "Returns rounded values for input_expr."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/round")
    ),
    ...
    ("SIN", FunctionInfo::new(
        "SIN",
        "Computes the sine of its argument; the argument should be expressed in radians."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/sin")
    ),
    ("SINH", FunctionInfo::new(
        "SINH",
        "Computes the hyperbolic sine of its argument."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/sinh")
    ),
    ("SQRT", FunctionInfo::new(
        "SQRT",
        "Returns the square-root of a non-negative numeric expression."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/sqrt")
    ),
    ...
    ("TAN", FunctionInfo::new(
        "TAN",
        "Computes the tangent of its argument; the argument should be expressed in radians."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/tan")
    ),
    ("TANH", FunctionInfo::new(
        "TANH",
        "Computes the hyperbolic tangent of its argument."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/tanh")
    ),
    ("TRUNCATE , TRUNC", FunctionInfo::new(
        "TRUNCATE , TRUNC",
...
pub const SEMISTRUCTURED_FUNCTIONS: &[(&str, FunctionInfo)] = &[
    ("ARRAYS_OVERLAP", FunctionInfo::new(
        "ARRAYS_OVERLAP",
        "Compares whether two arrays have at least one element in common."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/arrays_overlap")
    .with_subcategory("array")
    ),
    ("ARRAYS_TO_OBJECT", FunctionInfo::new(
        "ARRAYS_TO_OBJECT",
        "Returns an OBJECT that contains the keys specified by one input ARRAY and the values specified by another input ARRAY."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/arrays_to_object")
    .with_subcategory("array")
    ),
    ("ARRAYS_ZIP", FunctionInfo::new(
        "ARRAYS_ZIP",
        "Returns an array of objects, each of which contains key-value pairs for an nth element in the input arrays."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/arrays_zip")
    .with_subcategory("array")
    ),
    ("ARRAY_APPEND", FunctionInfo::new(
        "ARRAY_APPEND",
        "Returns an array containing all elements from the source array as well as the new element."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/array_append")
    .with_subcategory("array")
    ),
    ("ARRAY_CAT", FunctionInfo::new(
        "ARRAY_CAT",
        "Returns a concatenation of two arrays."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/array_cat")
    .with_subcategory("array")
    ),
    ("ARRAY_COMPACT", FunctionInfo::new(
        "ARRAY_COMPACT",
        "Returns a compacted array with missing and null values removed, effectively converting sparse arrays into dense arrays."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/array_compact")
    .with_subcategory("array")
    ),
    ("ARRAY_CONSTRUCT", FunctionInfo::new(
        "ARRAY_CONSTRUCT",
        "Returns an array constructed from zero, one, or more inputs."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/array_construct")
    .with_subcategory("array")
    ),
    ...
    ("ARRAY_CONTAINS", FunctionInfo::new(
        "ARRAY_CONTAINS",
        "Returns TRUE if the specified value is found in the specified array."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/array_contains")
    .with_subcategory("array")
    ),
    ("ARRAY_DISTINCT", FunctionInfo::new(
        "ARRAY_DISTINCT",
        "Returns a new ARRAY that contains only the distinct elements from the input ARRAY."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/array_distinct")
    .with_subcategory("array")
    ),
    ("ARRAY_EXCEPT", FunctionInfo::new(
        "ARRAY_EXCEPT",
        "Returns a new ARRAY that contains the elements from one input ARRAY that are not in another input ARRAY."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/array_except")
    .with_subcategory("array")
    ),
    ("ARRAY_FLATTEN", FunctionInfo::new(
        "ARRAY_FLATTEN",
        "Flattens an ARRAY of ARRAYs into a single ARRAY."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/array_flatten")
    .with_subcategory("array")
    ),
    ("ARRAY_GENERATE_RANGE", FunctionInfo::new(
        "ARRAY_GENERATE_RANGE",
        "Returns an ARRAY of integer values within a specified range (e.g. [2, 3, 4])."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/array_generate_range")
    .with_subcategory("array")
    ),
    ("ARRAY_INSERT", FunctionInfo::new(
        "ARRAY_INSERT",
        "Returns an array containing all elements from the source array as well as the new element."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/array_insert")
    .with_subcategory("array")
    ),
    ("ARRAY_INTERSECTION", FunctionInfo::new(
        "ARRAY_INTERSECTION",
        "Returns an array that contains the matching elements in the two input arrays."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/array_intersection")
    .with_subcategory("array")
    ),
    ("ARRAY_MAX", FunctionInfo::new(
        "ARRAY_MAX",
        "Given an input ARRAY, returns the element with the highest value that is not a SQL NULL."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/array_max")
    .with_subcategory("array")
    ),
    ("ARRAY_MIN", FunctionInfo::new(
        "ARRAY_MIN",
        "Given an input ARRAY, returns the element with the lowest value that is not a SQL NULL."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/array_min")
    .with_subcategory("array")
    ),
    ("ARRAY_POSITION", FunctionInfo::new(
        "ARRAY_POSITION",
        "Returns the index of the first occurrence of an element in an array."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/array_position")
    .with_subcategory("array")
    ),
    ("ARRAY_PREPEND", FunctionInfo::new(
        "ARRAY_PREPEND",
        "Returns an array containing the new element as well as all elements from the source array."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/array_prepend")
    .with_subcategory("array")
    ),
    ("ARRAY_REMOVE", FunctionInfo::new(
        "ARRAY_REMOVE",
        "Given a source ARRAY, returns an ARRAY with elements of the specified value removed."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/array_remove")
    .with_subcategory("array")
    ),
    ("ARRAY_REMOVE_AT", FunctionInfo::new(
        "ARRAY_REMOVE_AT",
        "Given a source ARRAY, returns an ARRAY with the element at the specified position removed."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/array_remove_at")
    .with_subcategory("array")
    ),
    ("ARRAY_REVERSE", FunctionInfo::new(
        "ARRAY_REVERSE",
        "Returns an array with the elements of the input array in reverse order."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/array_reverse")
    .with_subcategory("array")
    ),
    ("ARRAY_SIZE", FunctionInfo::new(
        "ARRAY_SIZE",
        "Returns the size of the input array."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/array_size")
    .with_subcategory("array")
    ),
    ("ARRAY_SLICE", FunctionInfo::new(
        "ARRAY_SLICE",
        "Returns an array constructed from a specified subset of elements of the input array."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/array_slice")
    .with_subcategory("array")
    ),
    ("ARRAY_SORT", FunctionInfo::new(
        "ARRAY_SORT",
        "Returns an ARRAY that contains the elements of the input ARRAY sorted in ascending or descending order."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/array_sort")
    .with_subcategory("array")
    ),
    ("ARRAY_TO_STRING", FunctionInfo::new(
        "ARRAY_TO_STRING",
    ...
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/array_to_string")
    .with_subcategory("array")
    ),
    ("AS_<object_type>", FunctionInfo::new(
        "AS_<object_type>",
        "You can use this family of functions to perform strict casting of VARIANT values to values of other data types."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/as")
    ...
    ("AS_CHAR , AS_VARCHAR", FunctionInfo::new(
        "AS_CHAR , AS_VARCHAR",
    ...
    ("AS_DECIMAL , AS_NUMBER", FunctionInfo::new(
    ...
    ("AS_DOUBLE , AS_REAL", FunctionInfo::new(
        "AS_DOUBLE , AS_REAL",
    ...
    ("AS_TIMESTAMP_*", FunctionInfo::new(
        "AS_TIMESTAMP_*",
    ...
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/get")
    ),
    ...
    ("GET_PATH , :", FunctionInfo::new(
        "GET_PATH , :",
        "Extracts a value from semi-structured data using a path name."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/get_path")
    ),
    ("IS_<object_type>", FunctionInfo::new(
        "IS_<object_type>",
    ...
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/is")
    ),
    ("IS_ARRAY", FunctionInfo::new(
        "IS_ARRAY",
        "Returns TRUE if its VARIANT argument contains an ARRAY value."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/is_array")
    ),
    ...
    ("IS_CHAR , IS_VARCHAR", FunctionInfo::new(
        "IS_CHAR , IS_VARCHAR",
    ...
    ("IS_DATE , IS_DATE_VALUE", FunctionInfo::new(
    ...
    ("IS_DOUBLE , IS_REAL", FunctionInfo::new(
        "IS_DOUBLE , IS_REAL",
    ...
    ("IS_OBJECT", FunctionInfo::new(
        "IS_OBJECT",
        "Returns TRUE if its VARIANT argument contains an OBJECT value."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/is_object")
    ),
    ...
    ("IS_TIMESTAMP_*", FunctionInfo::new(
        "IS_TIMESTAMP_*",
    ...
    ("MAP_KEYS", FunctionInfo::new(
        "MAP_KEYS",
        "Returns the keys in a MAP."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/map_keys")
    .with_subcategory("map")
    ),
    ...
    ("OBJECT_CONSTRUCT", FunctionInfo::new(
        "OBJECT_CONSTRUCT",
        "Returns an OBJECT constructed from the arguments."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/object_construct")
    ...
    ("OBJECT_DELETE", FunctionInfo::new(
        "OBJECT_DELETE",
        "Returns an object containing the contents of the input (that is, source) object with one or more keys removed."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/object_delete")
    .with_subcategory("object")
    ),
    ("OBJECT_INSERT", FunctionInfo::new(
        "OBJECT_INSERT",
    ...
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/object_insert")
    .with_subcategory("object")
    ),
    ("OBJECT_KEYS", FunctionInfo::new(
        "OBJECT_KEYS",
        "Returns an array containing the list of keys in the top-most level of the input object."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/object_keys")
    .with_subcategory("object")
    ),
    ("OBJECT_PICK", FunctionInfo::new(
        "OBJECT_PICK",
        "Returns a new OBJECT containing some of the key-value pairs from an existing object."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/object_pick")
    .with_subcategory("object")
    ),
    ("PARSE_JSON", FunctionInfo::new(
        "PARSE_JSON",
        "Interprets an input string as a JSON document, producing a VARIANT value."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/parse_json")
    .with_subcategory("json")
    ),
    ...
    ("STRTOK_TO_ARRAY", FunctionInfo::new(
        "STRTOK_TO_ARRAY",
        "Tokenizes the given string using the given set of delimiters and returns the tokens as an array."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/strtok_to_array")
    ),
...
pub const STRING_BINARY_FUNCTIONS: &[(&str, FunctionInfo)] = &[
    ("ASCII", FunctionInfo::new(
        "ASCII",
        "Returns the ASCII code for the first character of a string."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/ascii")
    ),
    ...
    ("BIT_LENGTH", FunctionInfo::new(
        "BIT_LENGTH",
        "Returns the length of a string or binary value in bits."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/bit_length")
    ),
    ...
    ("CLASSIFY_TEXT (SNOWFLAKE.CORTEX)", FunctionInfo::new(
    ...
    ("COMPLETE (SNOWFLAKE.CORTEX)", FunctionInfo::new(
    ...
    ("CONCAT , ||", FunctionInfo::new(
        "CONCAT , ||",
        "Concatenates one or more strings, or concatenates one or more binary values."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/concat")
    ),
    ("CONCAT_WS", FunctionInfo::new(
        "CONCAT_WS",
        "Concatenates two or more strings, or concatenates two or more binary values."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/concat_ws")
    ),
    ("CONTAINS", FunctionInfo::new(
        "CONTAINS",
        "Returns true if expr1 contains expr2."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/contains")
    ),
    ("COUNT_TOKENS (SNOWFLAKE.CORTEX)", FunctionInfo::new(
    ...
    ("EMBED_TEXT_1024 (SNOWFLAKE.CORTEX)", FunctionInfo::new(
    ...
    ("EMBED_TEXT_768 (SNOWFLAKE.CORTEX)", FunctionInfo::new(
    ...
    ("EXTRACT_ANSWER (SNOWFLAKE.CORTEX)", FunctionInfo::new(
    ...
    ("FINETUNE ('CANCEL') (SNOWFLAKE.CORTEX)", FunctionInfo::new(
    ...
    ("FINETUNE ('CREATE') (SNOWFLAKE.CORTEX)", FunctionInfo::new(
    ...
    ("FINETUNE ('DESCRIBE') (SNOWFLAKE.CORTEX)", FunctionInfo::new(
    ...
    ("FINETUNE ('SHOW') (SNOWFLAKE.CORTEX)", FunctionInfo::new(
    ...
    ("FINETUNE (SNOWFLAKE.CORTEX)", FunctionInfo::new(
    ...
    ("LEFT", FunctionInfo::new(
        "LEFT",
        "Returns a leftmost substring of its input."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/left")
    ),
    ("LENGTH, LEN", FunctionInfo::new(
        "LENGTH, LEN",
    ...
    ("LOWER", FunctionInfo::new(
        "LOWER",
        "Returns the input string with all characters converted to lowercase."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/lower")
    ),
    ("LPAD", FunctionInfo::new(
        "LPAD",
        "Left-pads a string with characters from another string, or left-pads a binary value with bytes from another binary value."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/lpad")
    ),
    ("LTRIM", FunctionInfo::new(
        "LTRIM",
        "Removes leading characters, including whitespace, from a string."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/ltrim")
    ),
    ("MD5 , MD5_HEX", FunctionInfo::new(
        "MD5 , MD5_HEX",
    ...
    ("MD5_NUMBER — Obsoleted", FunctionInfo::new(
        "MD5_NUMBER — Obsoleted",
        "Returns the 128-bit MD5 message digest interpreted as a signed 128-bit big endian number."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/md5_number")
    ),
    ...
    ("OCTET_LENGTH", FunctionInfo::new(
        "OCTET_LENGTH",
        "Returns the length of a string or binary value in bytes."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/octet_length")
    ),
    ("PARSE_DOCUMENT (SNOWFLAKE.CORTEX)", FunctionInfo::new(
    ...
    ("POSITION", FunctionInfo::new(
        "POSITION",
        "Searches for the first occurrence of the first argument in the second argument and, if successful, returns the position (1-based) of the first argument in the second argument."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/position")
    ),
    ("REGEXP_COUNT", FunctionInfo::new(
        "REGEXP_COUNT",
        "Returns the number of times that a pattern occurs in a string."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/regexp_count")
    ...
    ("REGEXP_LIKE", FunctionInfo::new(
        "REGEXP_LIKE",
        "Performs a comparison to determine whether a string matches a specified pattern."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/regexp_like")
    .with_subcategory("regex")
    ),
    ("REGEXP_REPLACE", FunctionInfo::new(
        "REGEXP_REPLACE",
    ...
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/regexp_replace")
    .with_subcategory("regex")
    ),
    ("REGEXP_SUBSTR", FunctionInfo::new(
        "REGEXP_SUBSTR",
        "Returns the substring that matches a regular expression within a string."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/regexp_substr")
    .with_subcategory("regex")
    ),
    ...
    ("REPEAT", FunctionInfo::new(
        "REPEAT",
        "Builds a string by repeating the input for the specified number of times."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/repeat")
    ),
    ("REPLACE", FunctionInfo::new(
        "REPLACE",
        "Removes all occurrences of a specified substring, and optionally replaces them with another substring."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/replace")
    ),
    ("REVERSE", FunctionInfo::new(
        "REVERSE",
        "Reverses the order of characters in a string, or of bytes in a binary value."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/reverse")
    ),
    ("RIGHT", FunctionInfo::new(
        "RIGHT",
        "Returns a rightmost substring of its input."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/right")
    ),
    ("RPAD", FunctionInfo::new(
        "RPAD",
    ...
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/rpad")
    ),
    ("RTRIM", FunctionInfo::new(
        "RTRIM",
        "Removes trailing characters, including whitespace, from a string."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/rtrim")
    ),
    ("RTRIMMED_LENGTH", FunctionInfo::new(
        "RTRIMMED_LENGTH",
        "Returns the length of its argument, minus trailing whitespace, but including leading whitespace."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/rtrimmed_length")
    ),
    ...
    ("SEARCH_PREVIEW (SNOWFLAKE.CORTEX)", FunctionInfo::new(
    ...
    ("SENTIMENT (SNOWFLAKE.CORTEX)", FunctionInfo::new(
    ...
    ("SHA1 , SHA1_HEX", FunctionInfo::new(
        "SHA1 , SHA1_HEX",
    ...
    ("SHA2 , SHA2_HEX", FunctionInfo::new(
        "SHA2 , SHA2_HEX",
    ...
    ("SPLIT_PART", FunctionInfo::new(
        "SPLIT_PART",
        "Splits a given string at a specified character and returns the requested part."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/split_part")
    ),
    ("SPLIT_TEXT_RECURSIVE_CHARACTER (SNOWFLAKE.CORTEX)", FunctionInfo::new(
    ...
    ("SUBSTR , SUBSTRING", FunctionInfo::new(
        "SUBSTR , SUBSTRING",
    ...
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/substr")
    ),
    ("SUMMARIZE (SNOWFLAKE.CORTEX)", FunctionInfo::new(
    ...
    ("TRANSLATE", FunctionInfo::new(
        "TRANSLATE",
        "Replaces characters in a string."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/translate")
    ),
    ("TRANSLATE (SNOWFLAKE.CORTEX)", FunctionInfo::new(
        "TRANSLATE (SNOWFLAKE.CORTEX)",
        "Translates the given input text from one supported language to another."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/translate-snowflake-cortex")
    .with_subcategory("llm")
    ),
    ("TRIM", FunctionInfo::new(
        "TRIM",
        "Removes leading and trailing characters from a string."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/trim")
    ),
    ...
    ("TRY_COMPLETE (SNOWFLAKE.CORTEX)", FunctionInfo::new(
    ...
    ("UPPER", FunctionInfo::new(
        "UPPER",
        "Returns the input string with all characters converted to uppercase."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/upper")
    ),
    ("[ NOT ] ILIKE", FunctionInfo::new(
        "[ NOT ] ILIKE",
        "Performs a case-insensitive comparison to determine whether a string matches or does not match a specified pattern."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/ilike")
    ),
    ("[ NOT ] LIKE", FunctionInfo::new(
        "[ NOT ] LIKE",
        "Performs a case-sensitive comparison to determine whether a string matches or does not match a specified pattern."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/like")
    ),
    ("[ NOT ] REGEXP", FunctionInfo::new(
        "[ NOT ] REGEXP",
        "Performs a comparison to determine whether a string matches or does not match a specified pattern."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/regexp")
    .with_subcategory("regex")
    ),
    ("[ NOT ] RLIKE", FunctionInfo::new(
        "[ NOT ] RLIKE",
        "Performs a comparison to determine whether a string matches or does not match a specified pattern."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/rlike")
    .with_subcategory("regex")
    ),
];
...
pub const SYSTEM_FUNCTIONS: &[(&str, FunctionInfo)] = &[
    ...
    ("GET_PYTHON_PROFILER_OUTPUT (SNOWFLAKE.CORE)", FunctionInfo::new(
    ...
    ("SYSTEM$ADD_EVENT (for Snowflake Scripting)", FunctionInfo::new(
    ...
    ("SYSTEM$CLUSTERING_RATIO — Deprecated", FunctionInfo::new(
        "SYSTEM$CLUSTERING_RATIO — Deprecated",
        "Calculates the clustering ratio for a table, based on one or more columns in the table."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/system_clustering_ratio")
    ),
    ...
    ("SYSTEM$DATABASE_REFRESH_HISTORY — Deprecated", FunctionInfo::new(
        "SYSTEM$DATABASE_REFRESH_HISTORY — Deprecated",
        "Returns a JSON object showing the refresh history for a secondary database."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/system_database_refresh_history")
    ),
    ("SYSTEM$DATABASE_REFRESH_PROGRESS , SYSTEM$DATABASE_REFRESH_PROGRESS_BY_JOB — Deprecated", FunctionInfo::new(
    ...
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/system_database_refresh_progress")
    ),
    ...
    ("SYSTEM$GET_SERVICE_STATUS — Deprecated", FunctionInfo::new(
        "SYSTEM$GET_SERVICE_STATUS — Deprecated",
        "Retrieves the status of a Snowpark Container Services service."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/system_get_service_status")
    ),
    ...
    ("SYSTEM$LOG, SYSTEM$LOG_<level> (for Snowflake Scripting)", FunctionInfo::new(
        "SYSTEM$LOG, SYSTEM$LOG_<level> (for Snowflake Scripting)",
        "Logs a message at the specified severity level."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/system_log")
    ),
    ...
    ("SYSTEM$REGISTRY_LIST_IMAGES — Deprecated", FunctionInfo::new(
        "SYSTEM$REGISTRY_LIST_IMAGES — Deprecated",
        "Lists images in an image repository."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/system_registry_list_images")
    ),
    ...
    ("SYSTEM$SET_SPAN_ATTRIBUTES (for Snowflake Scripting)", FunctionInfo::new(
    ...
    ("SYSTEM$WHITELIST — Deprecated", FunctionInfo::new(
        "SYSTEM$WHITELIST — Deprecated",
        "Returns hostnames and port numbers to add to your firewall’s allowed list so that you can access Snowflake from behind your firewall."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/system_whitelist")
    ),
    ("SYSTEM$WHITELIST_PRIVATELINK — Deprecated", FunctionInfo::new(
        "SYSTEM$WHITELIST_PRIVATELINK — Deprecated",
        "Returns hostnames and port numbers for AWS PrivateLink, Azure Private Link, and Google Cloud Private Service Connect deployments to add to your firewall’s allowed list so that you can access Snowflake from behind your firewall."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/system_whitelist_privatelink")
    ),
];
...
pub const TABLE_FUNCTIONS: &[(&str, FunctionInfo)] = &[
    ...
    ("FLATTEN", FunctionInfo::new(
        "FLATTEN",
        "Flattens (explodes) compound values into multiple rows."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/flatten")
    ),
    ...
    ("GET_LINEAGE (SNOWFLAKE.CORE)", FunctionInfo::new(
...
pub const WINDOW_FUNCTIONS: &[(&str, FunctionInfo)] = &[
    ...
    ("CUME_DIST", FunctionInfo::new(
        "CUME_DIST",
        "Finds the cumulative distribution of a value with regard to other values within the same window partition."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/cume_dist")
    ),
    ("DENSE_RANK", FunctionInfo::new(
        "DENSE_RANK",
        "Returns the rank of a value within a group of values, without gaps in the ranks."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/dense_rank")
    ),
    ("FIRST_VALUE", FunctionInfo::new(
        "FIRST_VALUE",
        "Returns the first value within an ordered group of values."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/first_value")
    ),
    ("LAG", FunctionInfo::new(
        "LAG",
        "Accesses data in a previous row in the same result set without having to join the table to itself."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/lag")
    ),
    ("LAST_VALUE", FunctionInfo::new(
        "LAST_VALUE",
        "Returns the last value within an ordered group of values."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/last_value")
    ),
    ("LEAD", FunctionInfo::new(
        "LEAD",
        "Accesses data in a subsequent row in the same result set without having to join the table to itself."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/lead")
    ),
    ("NTH_VALUE", FunctionInfo::new(
        "NTH_VALUE",
        "Returns the nth value (up to 1000) within an ordered group of values."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/nth_value")
    ),
    ("NTILE", FunctionInfo::new(
        "NTILE",
        "Divides an ordered data set equally into the number of buckets specified by constant_value."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/ntile")
    ),
    ("PERCENT_RANK", FunctionInfo::new(
        "PERCENT_RANK",
        "Returns the relative rank of a value within a group of values, specified as a percentage ranging from 0.0 to 1.0."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/percent_rank")
    ),
    ("RANK", FunctionInfo::new(
        "RANK",
        "Returns the rank of a value within an ordered group of values."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/rank")
    ),
    ...
    ("ROW_NUMBER", FunctionInfo::new(
        "ROW_NUMBER",
        "Returns a unique row number for each row within a window partition."
    )
    .with_docs("https://docs.snowflake.com/en/sql-reference/functions/row_number")
    ),
];
