...
#[derive(Snafu, Debug)]
pub struct IcebergCatalogAPIError(pub MetastoreError);
pub type IcebergCatalogResult<T> = Result<T, IcebergCatalogAPIError>;

impl IntoResponse for IcebergCatalogAPIError {
