...
use icebucket_metastore::{IceBucketVolumeType, IceBucketFileVolume, IceBucketS3Volume, AwsCredentials, AwsAccessKeyCredentials};
...
async fn test_ui_volumes_file() {
    ...
    let expected = IceBucketVolume {
        ident: "".to_string(),
        volume: IceBucketVolumeType::File(
            IceBucketFileVolume{
    ...
    let expected = IceBucketVolume {
        ...
        volume: IceBucketVolumeType::S3(
            IceBucketS3Volume{
                ...
                credentials: Some(AwsCredentials::AccessKey(
