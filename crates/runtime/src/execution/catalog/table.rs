...
use iceberg_rust::table::manifest::ManifestReader;
use iceberg_rust::table::manifest_list::ManifestListReader;
use iceberg_rust::table::transaction::TableTransaction;
use iceberg_rust_spec::snapshot::Snapshot;
use icebucket_metastore::{IceBucketTable, Metastore};
...
#[derive(Debug, Clone)]
/// Iceberg table
pub struct IceBucketIcebergTable {
    table: IceBucketTable,
    metastore: Arc<dyn Metastore>,
}

/// Public interface of the table.
impl IceBucketIcebergTable {
    ...
    pub async fn object_store(&self) -> Arc<dyn ObjectStore> {
        self.metastore.table_object_store(&self.table.ident)
    }
